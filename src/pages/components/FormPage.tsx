...
export function FormPage() {
  return (
    <ComponentShowcase
      ...
      usage={`Use Form components to build accessible, validated forms with React Hook Form.
• FormField connects to form control
• FormLabel, FormDescription, FormMessage for accessibility
• Zod schema for type-safe validation`}
      props={[
        { name: 'form', type: 'UseFormReturn', description: 'React Hook Form instance' },
        { name: 'onSubmit', type: '(values) => void', description: 'Form submission handler' },
      ]}
    />
  );
}

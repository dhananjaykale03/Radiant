...
export function NavigationMenuPage() {
  return (
    <ComponentShowcase
      ...
      usage={`Use Navigation Menu for main site navigation with dropdowns.
• Ideal for header navigation with rich dropdowns
• Supports keyboard navigation
• Animated viewport for smooth transitions`}
      props={[
        { name: 'children', type: 'ReactNode', description: 'Navigation content' },
